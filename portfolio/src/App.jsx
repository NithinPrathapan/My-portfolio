    ...
    <div className={darkMode ? "dark" : ""}>
      <main className="bg-[#fff] px-5  md:px-20 lg:px-40 dark:bg-gradient-to-t from-[#000] to-slate-900 ">
        ...
        <section>
          <div className="py-2 mt-6 max-w-4xl mx-auto">
            <h1 className="text-center font-poppins uppercase font-semibold tracking-widest text-teal-500  text-[1.6rem]    ">
      ...
      <section className="min-w- bg-[#000] ">
        <div className="max-w-4xl text-center py-6 mx-auto">
          ...
          <div className="md:w-[100%] w-[80%] md:px-4 px-2  items-center flex mt-4 justify-between mx-auto">
            <div className="flex flex-col  text-white font-dancing">
              <h1 className="md:text-3xl text-[#d7d3d3]">Let's Connect</h1>
              <h1 className="md:text-2xl text-teal-500 font-semibold">
                Digitally
              </h1>
            ...
            <div className="text-center flex flex-col gap-1">
              <h1 className="hover:underline font-poppins decoration-slate-100 underline-offset-4 cursor-pointer text-white uppercase tracking-wide md:text-2xl ">
                Email
              </h1>
              <h1 className="hover:underline font-poppins decoration-slate-100 underline-offset-4 cursor-pointer text-teal-500 uppercase tracking-wide md:text-2xl ">
                Twitter
              </h1>
              <h1 className="hover:underline font-poppins decoration-slate-100 underline-offset-4 cursor-pointer text-white uppercase tracking-wide md:text-2xl ">
                Linkedin
